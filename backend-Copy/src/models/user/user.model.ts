...
class UserModel extends ModelBase {
  ...
  private last_time_on_app: any;
  private is_vca_completed: any;
  private vca_account: any;
  private link_email_activation: any;
  private accept_terms: any;
  private is_account_actived: any;
  ...
  constructor(args: any, dependencies: any) {
    ...
    this.role = { value: args.role || this.roles.business, type: dependencies.dal.types.string }
