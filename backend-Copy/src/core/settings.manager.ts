class SettingsManager {
  ...
  globalDependencies () {
    ...
    this._dependencies.core.add((str: string) => {
      try {
        JSON.parse(str)
      } catch (e) {
        return false
  ...
  stringIndexOfExtension () {
    ...
    Object.defineProperty(String.prototype, 'regexIndexOf', {
      ...
      enumerable: true,
      configurable: false,
      value: function (regex: string, startpos: string) {
  ...
  stringLastIndexOfExtension () {
    ...
    Object.defineProperty(String.prototype, 'regexLastIndexOf', {
      ...
      enumerable: true,
      configurable: false,
      value: function (regex: any, startpos: number) {
        regex = (regex.global)
          ? regex
  ...
  stringReplaceAtExtension () {
    ...
    Object.defineProperty(String.prototype, 'replaceAt', {
      ...
      enumerable: true,
      configurable: false,
      value: function (index: number, replacement: string) {
  ...
  stringCapitalizeExtension () {
    ...
    Object.defineProperty(String.prototype, 'capitalize', {
      ...
      configurable: false,
      value: function () {
        return this.replace(/\b\w/g, (l: string) => l.toUpperCase())
      }
    })
  }
  ...
  forEachExtension () {
    ...
    Object.defineProperty(Array.prototype, 'asyncForEach', {
      ...
      enumerable: true,
      configurable: false,
      value: async function (callback: any, thisArg: object) {
        thisArg = thisArg || {}
